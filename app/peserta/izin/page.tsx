...
export default async function IzinPage({
  ...
  return (
    <div className="mx-auto w-full max-w-full space-y-6 overflow-x-hidden p-3 box-border sm:p-6">
      <div>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <section className="w-full max-w-full lg:col-span-2">
          <div className="w-full max-w-full box-border rounded-2xl border border-slate-200/80 bg-white p-3 shadow-sm sm:p-6">
        ...
        <section className="w-full max-w-full lg:col-span-3">
          <div className="w-full max-w-full box-border overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
